...
(define keyLst (list
                ...
                ;; ––– •non char key• –––
                ;; -- •Functional key• ––
                (cons '(XF86MonBrightnessDown) "light -U 5")
                (cons '(XF86MonBrightnessUp) "light -A 5")
                (cons '(XF86AudioRaiseVolume) "lmc up 5")
                (cons '(XF86AudioLowerVolume) "lmc down 5")
                (cons '(XF86AudioMute) "lmc mute")
